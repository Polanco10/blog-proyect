...
router
    ...
    .post(authController.protect, authController.restrictTo('admin'), validateQuickTip, quicktipController.createQuickTip);

router
    .route('/:id')
    .get(quicktipController.getQuickTip)
    .patch(authController.protect, authController.restrictTo('admin'), validateQuickTip, quicktipController.updateQuickTip)

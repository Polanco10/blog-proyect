...
router
    ...
    .post(authController.protect, authController.restrictTo('admin'), cheatsheetController.createCheatsheet);

router
    .route('/:id')
    .get(cheatsheetController.getCheatsheet)
    .patch(authController.protect, authController.restrictTo('admin'), cheatsheetController.updateCheatsheet)

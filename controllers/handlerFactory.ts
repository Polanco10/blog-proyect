...
exports.deleteOne = (Model: mongoose.Model<any>) => catchAsync(async (req: Request, res: Response, next: NextFunction) => {
...
exports.updateOne = (Model: mongoose.Model<any>) => catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    if (!mongoose.isValidObjectId(req.params.id))
        return next(new AppError('No document found with that ID', 404));
...
exports.createOne = (Model: mongoose.Model<any>) => catchAsync(async (req: Request, res: Response) => {
    const key = singularKey(Model.collection.collectionName);
...
exports.getOne = (Model: mongoose.Model<any>) => catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    if (!mongoose.isValidObjectId(req.params.id))
        return next(new AppError('No document found with that ID', 404));
    const key = singularKey(Model.collection.collectionName);
...
exports.getAll = (Model: mongoose.Model<any>) => catchAsync(async (req: Request, res: Response) => {

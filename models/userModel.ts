        ...
        passwordConfirm: {
            ...
            validate: {
                validator: function (el) {
                    // Solo funciona con .create() .save() y no con findOne o update
...
userSchema.methods.correctPassword = async function (candidatePassword, userPassword) {
    //Instance method - compara si las paswords son iguales / para usar en el login
    return await bcrypt.compare(candidatePassword, userPassword);
};
userSchema.methods.changedPasswordAfter = function (JWTTimestamp) {
    //Compara la fecha en que se cambio la password con la fecha en que se loggeo
